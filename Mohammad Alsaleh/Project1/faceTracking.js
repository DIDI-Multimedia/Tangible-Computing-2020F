...
fontRegular = loadFont('./Project1/Cyberpunk.ttf');
Helveticaa = loadFont('./Project1/Helvetica 400.ttf');
bgg = loadImage('./Project1/bgg.jpg')
img = loadImage('./Project1/ship.png')
